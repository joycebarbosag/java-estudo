...
public class ImprimirFormatado {
	...
	public static void main(String[] args) {
		...
		//para formatar dados --> %.qtd+f+%n onde: f substitui a variável flutuante e n quebra a linha
		//três casas decimais
		...
		//sem ser número, f vira s
		System.out.printf("Meu nome é %s. %nE o seu?%n", nome);
		...
		System.out.printf("%s têm %d anos e recebe %.3f reais.", nome, idade, salario);
