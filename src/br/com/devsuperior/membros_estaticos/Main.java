...
public class Main {
	...
	public static void main(String[] args) {
		...
		//como n�o criei os m�todos como static, eu s� posso chamar se instanciar a classe
		...
		System.out.printf("Circunfer�ncia: %.2f%nVolume: %.2f%nValor de PI: %.2f%n", c, v, calc.PI);
		...
		System.out.printf("Circunfer�ncia: %.2f%nVolume: %.2f%nValor de PI: %.2f%n", c2, v2, StaticCalculator.PI);
	}
